...
$upload_dir = '/storage/files/sources/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../../storage/files/sources/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../../../../storage/files/thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
...
$default_language 	= "cs"; //default language file name
