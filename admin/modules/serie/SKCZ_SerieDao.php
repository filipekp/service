<?php
  ...
  /**
   * Reprezentuje objekt pro přístup k datům entity serie ze serveru StyloveKoupelny.cz (DAO).
   * 
   * @author Jan Svěží
   * @copyright (c) 2014, Proclient s.r.o.
   */
  class SKCZ_SerieDao extends SQLDataAccessObject
  {
    public function __construct() {
      ...
      parent::__construct(SKCZ_SerieEntity::classname(), 'prosys\core\mapper\MySqlMapper', $mySqlHandler, 'serie');
    }
  }
