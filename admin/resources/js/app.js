...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function (e) {
          ...
          console.log('jsem-tu');
                ...
                var pageContentBody = $('.page-content .content-body');
                ...
                $.post(url, {}, function (res) {
                    ...
                    //window.history.pushState(res, document.title, link);
    ...
    var handleTabs = function () {
        ...
        if(hash !== '' && typeof(hash) !== 'undefined' && hash !== null) {
          selectedtab = $('li[data-tab="' + hash + '"]').toggleClass('active').index();
        }
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="./resources/images/ajax-loading.gif" align=""> Načítám ...',
