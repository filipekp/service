        ...
        $.fn.inputmask = function (fn, options) {
            ...
            function mask(el) {
                ...
                $input.closest('form').bind("submit", function () { //trigger change on submit if any
                    if (el._valueGet() != buffer.join('')) {
                      $input.change();
                    }
                    
                    if (opts.removeInputOnSubmit && !isComplete(el)) {
                ...
                .bind('validate.inputmask', function () {
                    var $input = $(this), input = this;
                    if (isComplete(input)) { 
                ...
                function isComplete(npt) {
                    ...
                    $(npt).data('isvalid', parseInt(+complete));
                ...
                function keyupEvent(e) {
                    ...
                    if ($.inArray(k, opts.ignorables) !== -1) {
                      isComplete(input);
                    }
                }
