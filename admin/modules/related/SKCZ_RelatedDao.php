<?php
  ...
  /**
   * Reprezentuje objekt pro přístup k datům entity souvisejiciho vyrobku ze serveru StyloveKoupelny.cz (DAO).
   * 
   * @author Jan Svěží
   * @copyright (c) 2014, Proclient s.r.o.
   */
  class SKCZ_RelatedDao extends SQLDataAccessObject
  {
    public function __construct() {
      ...
      parent::__construct(SKCZ_RelatedEntity::classname(), 'prosys\core\mapper\MySqlMapper', $mySqlHandler, 'vyrobky_souvisejici');
    }
  }
